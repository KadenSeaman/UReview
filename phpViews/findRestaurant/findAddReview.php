            ...
            <div class="dashboard-main">
                ...
                <div class="dashboard-list-container">
                    <?php
                        ...
                        echo <<< _END
                            <form class="restaurant-input-grid" method="post" action="findAddReview.php?restaurant_id=$restaurant_id&food_id=$food_id">
                                <input required readonly value=$username maxlength="30" type="text" name="username" id="review-username" placeholder="username">
