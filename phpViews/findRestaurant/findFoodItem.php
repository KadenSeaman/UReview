                ...
                <?php
                    ...
                    if($result->num_rows > 0){
                        while($row = $result->fetch_array(MYSQLI_ASSOC)){
                            echo "<div class='title'>$row[restaurant_name]'s food items</div>";
                        }
                    }
                    else{
                        ...
                        <?php
                            ...
                            if($result->num_rows > 0){
                                while($row = $result->fetch_array(MYSQLI_ASSOC)){
                                    echo <<< _END
                                            <li class="restaurant-list-item header-list-item">
                                                <a href="findReview.php?food_id=$row[food_id]&restaurant_id=$restaurant_id">$row[name]</a>
                                                <p>$row[price]</p>
                                                <p>$row[average_rating]</p>
                                                <p>$row[type]</p>
                                                <a href="findFoodItemInfo.php?food_id=$row[food_id]&restaurant_id=$restaurant_id">info</a>
                                            </li>
                                    _END;
                                }
                            }
