                    ...
                    <ul>
                        <li class="restaurant-list-item header-list-item">
                            ...
                            <?php
                                ...
                                echo "<a href='findAddReview.php?restaurant_id=$restaurant_id&food_id=$food_id' id='new-restaurant-btn'>+ new review</a>";
                        ?>
                        </li>
                        <?php
                            $page_roles = array('admin','owner','user');
                                    ...
                                    if($row['username'] === $username){
                                        echo <<< _END
                                            <li class="restaurant-list-item header-list-item">
                                                ...
                                                <a href="" id="restaurantFiller"></a>
                                                <a href="findUpdateReview.php?review_id=$row[review_id]&food_id=$food_id&restaurant_id=$restaurant_id">edit</a>
                                            </li>
                                        _END;
                                    }
                                    else{
