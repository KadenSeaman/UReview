                    ...
                    <ul>
                        <li class="restaurant-list-item header-list-item">
                            ...
                            <?php
                                ...
                                echo "<a href='ownerAddFoodItem.php?restaurant_id=$restaurant_id' id='new-restaurant-btn'>+ new item</a>"
                            ?>
                        </li>
                        <?php
                            $page_roles = array('owner');
                                ...
                                while($row = $result->fetch_array(MYSQLI_ASSOC)){
                                    echo <<< _END
                                            <li class="restaurant-list-item header-list-item">
                                                ...
                                                <p>$row[type]</p>
                                                <a href="ownerUpdateFoodItem.php?food_id=$row[food_id]&restaurant_id=$restaurant_id">edit</a>
                                                <form action='ownerDeleteFoodItem.php' method='post'>
