                        ...
                        if(isset($_GET['restaurant_id'])){
                            ...
                            if($result->num_rows > 0){
                                while($row = $result->fetch_array(MYSQLI_ASSOC)){
                                    echo <<<_END
                                        <form class='restaurant-input-grid' method='post' action='ownerUpdateRestaurant.php'>
                                            ...
                                            <a href="ownerViewRestaurant.php" id="cancel-change-restaurant">cancel</a>
...
if(isset($_POST['restaurant_id'])){
    ...
    header("Location: ownerViewRestaurant.php");
}
$conn->close();
?>